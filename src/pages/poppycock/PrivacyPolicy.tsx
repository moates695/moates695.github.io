...
import { Reveal, GradientText, PageHeader, Panel, PageNav } from "../../components/design";
  ...
  return (
    ...
    >
      <PageHeader
        ...
        subtitle="How Poppycock handles information when you use the app."
      />
...
**Entity name:** Poppycock`}
      ...
      <PageNav left={{ text: "Overview", link: "/poppycock" }} />
    </Box>
  );
}
